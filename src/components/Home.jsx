...
const Home = () => {
  ...
  return (
    <>
      <section
        id='home'
        className='grid md:grid-cols-2 bg-cyan-950 relative'
        style={{ height: '100vh' }}
      >
        <div
          className={`m-auto flex flex-row ${matches ? 'mobile' : 'desktop'}`}
        >
          <div
            data-aos='flip-left'
            data-aos-delay='1200'
            className={`flex flex-col m-auto flex-wrap justify-center me-10 ms-5  ${
              matches ? 'hidden' : ''
            }`}
            style={{ height: '100%' }}
          >
          ...
          <div>
            <div
              data-aos='fade-down'
              data-aos-delay='1200'
              className={`text-sky-200 text font-medium content1 ${
                matches ? 'text-2xl mt-10 text-center' : 'text-3xl'
              }`}
            >
              Hello, I'm
            </div>
            <div
              ...
              className={`text-sky-700 font-extrabold ${
                matches ? 'text-3xl my-3 text-center' : 'text-4xl my-5'
              }`}
            >
              Kutluhan Akarçeşme
            </div>
            <div
              data-aos='fade-down'
              data-aos-delay='800'
              className={`text-orange-500 font-semibold mb-8 animation content3 ${
                matches ? 'text-2xl text-center' : 'text-3xl'
              }`}
            >
              Back End Developer
            </div>
            <button
              ...
              ${matches ? 'w-full' : ''}`}
            >
              <a download='kutluhan-akarcesme-cv' href={cv}>
                Download CV
              </a>
            </button>
          </div>
        ...
        <div
          data-aos='fade-up'
          data-aos-delay='300'
          className='my-auto justify-center profile-image flex'
          style={{ height: '70%' }}
        >
          <img
            className={`z-20 rounded-full profilphoto mx-auto ${
              matches ? '' : 'my-auto'
            }`}
            style={photoStyle}
            src={profilphoto}
