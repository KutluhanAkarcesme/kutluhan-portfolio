...
import cardimage from '../assets/images/about.jpeg';
...
const Contact = () => {
  ...
  return (
    <section id='contact' className='bg-cyan-950 relative p-20'>
      <Toaster />
      <h2
        data-aos='fade-right'
      ...
      <div className='flex mb-10 mx-auto justify-center'>
        <div>
          <div
            className='flex bg-orange-600 p-5 rounded-xl font-semibold mx-auto'
            data-aos='zoom-in'
          >
            <div
              className={`flex border-r px-4 contact-info ${
                match1 ? 'hidden' : ''
              }`}
            >
              <img
                ...
                height='50px'
              />
              <span className='text-lg my-auto ms-2'>Kutluhan Akarçeşme</span>
            </div>
            <p
              className={`my-auto border-r px-4 contact-info-2 ${
                match2 ? 'hidden' : ''
              }`}
            >
      ...
      <div className='flex mx-auto justify-center' style={{ width: '100%' }}>
        <div
          className={`flex flex-col ${match2 ? 'hidden' : ''}`}
          data-aos='flip-right'
        >
          <button className='bg-orange-600 text-orange-100 font-semibold hover:bg-orange-600 pt-2 pb-1 px-3 me-5 mb-5 rounded shadow shadow-orange-800/100'>
            <a
              ...
              rel='noreferrer'
              target='_blank'
              href='mailto:kutluhanakarcesme@gmail.com'
            >
        ...
        >
          ...
          <input
            ...
            name='to_name'
            placeholder='Name'
            className='p-2 rounded-xl bg-orange-100 font-bold text-neutral-900 hidden'
            value='Kutluhan'
            disabled
          />
          <input
